...
!!-----------------------------------------------------------
!Write(*,*) "Tree Mhh", Mhh(1), Mhh(2), Mhh(3), Mhh(4), Mhh(5)
!TreeLMhh = Mhh
!!-----------------------------------------------------------
...
!OPEN(unit = 20, file = '/users/dkpatcha/works/RpvBayeS1.0.0/SusyMassPrecision.dat')
!Write(20,*) '# -- Contains info about precisons on susy masses calculations --'
!!!! Squarks
!DO iSQ = 1, 6
!!DeltaMSd(iSQ) = (MSd_1L(iSQ)-MSd(iSQ))/MSd_1L(iSQ)
!DeltaMSu(iSQ) = (MSu_1L(iSQ)-MSu(iSQ))/MSu_1L(iSQ)
!DeltaM_squarks = DeltaM_squarks + DeltaMSu(iSQ) + DeltaMSd(iSQ)
!Write(20,*) 'USquarks' , MSd_1L(iSQ), MSd(iSQ)
!rite(20,*) 'DSquarks' , MSu_1L(iSQ), MSu(iSQ)
!ENDDO
!! Charged higgs
!Write(20,*) '  '

!DO iSQ = 1, 8
!DeltaMCH(iSQ) = (MHpm_1L(iSQ)-MHpm(iSQ))/MHpm_1L(iSQ)
!DeltaM_CH = DeltaM_CH + DeltaMCH(iSQ)
!Write(20,*) 'Charged Higgs' ,MHpm_1L(iSQ),MHpm(iSQ)
!WRITE(*,*) Mhh(iSQ),' ', Mhh_1L(iSQ)
!WRITE(20,*) BRhh(iSQ,2), '  ',  BRhh(iSQ,99),' ', BRhh(iSQ,1)  !! DK
!ENDDO

!! Neutralinos
!Write(20,*) '  '
!DO iSQ = 1, 10
!DeltaMneu(iSQ) = (MChi_1L(iSQ)-MChi(iSQ))/MChi_1L(iSQ)
!DeltaM_neu = DeltaM_neu + DeltaMneu(iSQ)
!Write(20,*) 'Neutalinos' , MChi_1L(iSQ), MChi(iSQ)
!ENDDO
!! Charginos
!Write(20,*) '  '
!DO iSQ = 4, 5
!DeltaMcha(iSQ) = (MCha_1L(iSQ)-MCha(iSQ))/MCha_1L(iSQ)
!DeltaM_cha = DeltaM_cha + DeltaMcha(iSQ)
!Write(20,*) 'Charginos' , MCha_1L(iSQ), MCha(iSQ)
!ENDDO
!DeltaMGlu = (MGlu_1L-MGlu)/MGlu_1L
!Write(20,*) 'Gluino' , MGlu_1L, MGlu
!Write(20,*) '    '
!Write(20,*) '    '
!Write(20,*) ' Total precision',(DeltaM_squarks+DeltaM_CH+DeltaM_neu+DeltaM_cha+DeltaMGlu)/29
!!***********************************************************************************************
!write(*,*) Mhh_1L(1),Mhh_1L(2),Mhh_1L(3),Mhh_1L(4),Mhh_1L(5)!,Mhh_1L(6),Mhh_1L(7),Mhh_1L(8)
!write(*,*) Mhh(1),Mhh(2),Mhh(3),Mhh(4),Mhh(5)!,Mhh(6),Mhh(7),Mhh(8)
!write(*,*) '   '
!write(*,*) MAh_1L(1),MAh_1L(2),MAh_1L(3),MAh_1L(4),MAh_1L(5)!,MAh_1L(6),MAh_1L(7),MAh_1L(8)
!write(*,*) MAh(1),MAh(2),MAh(3),MAh(4),MAh(5)!,MAh(6),MAh(7),MAh(8)
!write(*,*) '   '
...
!!-----------------------------------------------------------
!Write(*,*) "Loop Mhh", Mhh_1L(1), Mhh_1L(2), Mhh_1L(3), Mhh_1L(4), Mhh_1L(5)
!TwoLMhh = Mhh
!!-----------------------------------------------------------
...
! write(*,*) 'MAh(1),MHpm(1)', MAh(1), MHpm(1)
...
Do i1=1,8
  ...
  Else 
   ...
   If ((i1.Gt.1).or. (Abs(mass2(i1)).gt.MaxVal(Abs(mass2))) ) Then 
     Write(*,*) 'Warning Check DK from routine '//NameOfUnit(Iname) 
     !Write(*,*) 'in the calculation of the masses' 
     !Write(*,*) 'occurred a negative mass squared!' 
   Call TerminateProgram
   return 
...
Do i1=8,1,-1 
PiSf(i1,:,:) = PiSf(i1,:,:) - PiP2S_EffPot !! Newly added
mat2 = mat2a - Real(PiSf(i1,:,:),dp) 
Call Chop(mat2) 
Call Eigensystem(mat2,mi2,RS,kont,test) 
If ((kont.Eq.-8).Or.(kont.Eq.-9)) Then 
...
!Write(*,*)' '
!Write(*,*) "MAh Af 2 Pi1LoopAh", i1, mass2(i1), MaxVal(mass2)
!Write(*,*) ' '
 ...
 If (mass2(i1).Ge.0._dp) Then 
    mass(i1) = sqrt(mass2(i1)) 
  Else 
     Write(*,*) 'Warning Check DK 2 from routine '//NameOfUnit(Iname) 
     !Write(*,*) 'in the calculation of the masses occurred a negative mass squared!' 
     Write(*,*) 'generation: ',i1 , mass2(i1)
     !Write(*,*) 'mass: ',mass2(i1) 
   SignOfMassChanged = .True. 
   mass(i1) = 0._dp 
  End If 
