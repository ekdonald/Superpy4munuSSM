...
! for higgstools
character(len=1000) :: HTrootname

!!------------------------ Setting the paths ---------------------------------------------------
character(len=1000) :: mydir, pathsph
!! where to write higgstools input files
!call getcwd(mydir) 
!pathsph = mydir
...
! get the rootname of higgstools input files
Call get_command_argument(2, HTrootname)
If (len_trim(HTrootname)==0) Then
    HTrootname="HB3"
    ! output filename
    outputFileName="output/SPheno.spc.munuSSM3G"
Else
    HTrootname=trim(HTrootname)
    ! output filename
    outputFileName="output/"//trim(HTrootname)//"SPheno.spc.munuSSM3G"
End if 


Call get_command_argument(3, mydir)
If (len_trim(mydir)==0) Then
    pathsph = "HBout3G"
Else
    pathsph = trim(mydir)
End if 
...
infHiggsB= trim(pathsph)//'/higgstools-main/buildpy/'


Open(87,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-MH_GammaTot.dat',status='unknown') 
Open(88,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-MHplus_GammaTot.dat',status='unknown') 
Open(89,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-effC.dat',status='unknown') 
Open(90,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-BR_H_NP.dat',status="unknown") 
Open(91,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-BR_Hplus.dat',status='unknown') 
Open(92,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-BR_t.dat',status="unknown") 
Open(93,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-LEP_HpHm_CS_ratios.dat',status='unknown') 
Open(94,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-MHall_uncertainties.dat',status='unknown')  
Open(95,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-BR_H_OP.dat',status="unknown") 
Open(96,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-LHC13_Hplus_hadCS.dat',status='unknown')  
Open(97,file= trim(infHiggsB)//'HBout3G/'//trim(HTrootname)//'-LHC8_Hplus_hadCS.dat',status="unknown") 
...
Write(91,"(3e16.8)",advance="No") BRHpm(2,111)
Write(91,"(3e16.8)",advance="No") BRHpm(3,111)
Write(91,"(3e16.8)",advance="No") BRHpm(4,111)
Write(91,"(3e16.8)",advance="No") BRHpm(5,111)
Write(91,"(3e16.8)",advance="No") BRHpm(6,111)
Write(91,"(3e16.8)",advance="No") BRHpm(7,111)
Write(91,"(3e16.8)",advance="No") BRHpm(8,111)

Write(91,"(3e16.8)",advance="No") BRHpm(2,112)
Write(91,"(3e16.8)",advance="No") BRHpm(3,112)
Write(91,"(3e16.8)",advance="No") BRHpm(4,112)
Write(91,"(3e16.8)",advance="No") BRHpm(5,112)
Write(91,"(3e16.8)",advance="No") BRHpm(6,112)
Write(91,"(3e16.8)",advance="No") BRHpm(7,112)
Write(91,"(3e16.8)",advance="No") BRHpm(8,112)

Write(91,"(3e16.8)",advance="No") BRHpm(2,69)
Write(91,"(3e16.8)",advance="No") BRHpm(3,69)
Write(91,"(3e16.8)",advance="No") BRHpm(4,69)
Write(91,"(3e16.8)",advance="No") BRHpm(5,69)
Write(91,"(3e16.8)",advance="No") BRHpm(6,69)
Write(91,"(3e16.8)",advance="No") BRHpm(7,69)
Write(91,"(3e16.8)",advance="No") BRHpm(8,69)
