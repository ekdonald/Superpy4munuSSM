...
BrZtoTauMu = 0._dp 
BrhtoMuE = 0._dp 
BrhtoTauE = 0._dp Q=  1.50000000E+03
BrhtoTauMu = 0._dp 
DeltaMBs = 0._dp 
ratioDeltaMBs = 0._dp 
DeltaMBq = 0._dp 
...
CalcTBD = .false. 
!OPEN(unit = 40, file = '/users/dkpatcha/works/RpvBayeS1.0.0/kont.dat')
!Write(40,*) '# -- Contains info about precisons on susy masses calculations --'
!write(*,*) 'kont =', kont   !!!!! BY DONALD
!stop
