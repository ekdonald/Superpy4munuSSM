...
if Debug:
    ...
    # 262144 kb = 256 mb.
    resource.setrlimit(resource.RLIMIT_STACK, (262144, 262144))		#MODIFIED this is the problem, maybe memory????

#else:
    # Disable printing to the screen from python.			#MODIFIED comented
    #sys.stdout = NullWriter()						#MODIFIED comented
