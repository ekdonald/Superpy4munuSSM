...
Character(len=1000)::inputFileName,outputFileName 
Contains 
...
!!-----------------------------------------------------------------
!! To be added in order to resume jobs from where it stopped
!! whenn postprocessing scan data
!     Case(995) !! Added by donald on Jan. 05 2018
!      If (int(wert) .Ne. 1) Then
!       ResumeJob=.False.
!      Else
!       ResumeJob=.True.
!      End If
